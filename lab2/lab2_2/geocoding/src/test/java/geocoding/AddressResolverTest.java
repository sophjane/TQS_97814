...
class AddressResolverTest {
    ...
    void whenResolveAlboiGps_returnCaisAlboiAddress() throws ParseException, IOException, URISyntaxException {
        ...
        // %2C means ,
        when(tqsBasicHttpClient.doHttpGet(contains("location=40.640661%2C-8.656688"))).thenReturn(jsonResponse);
    ...
    public void whenBadCoordidates_thenReturnNoValidAddress() throws IOException, URISyntaxException, ParseException {
        ...
        String jsonResponse ="{\"info\":{\"statuscode\":0,\"copyright\":{\"text\":\"\\u00A9 2022 MapQuest, Inc.\",\"imageUrl\":\"http://api.mqcdn.com/res/mqlogo.gif\",\"imageAltText\":\"\\u00A9 2021 MapQuest, Inc.\"},\"messages\":[]},\"options\":{\"maxResults\":1,\"thumbMaps\":true,\"ignoreLatLngInput\":false},\"results\":[{\"providedLocation\":{\"latLng\":{\"lat\":-300.000000,\"lng\":-810.000000}},\"locations\":[]}]}";

        when(tqsBasicHttpClient.doHttpGet(contains("location=-300.000000%2C-810.000000"))).thenReturn(jsonResponse);
