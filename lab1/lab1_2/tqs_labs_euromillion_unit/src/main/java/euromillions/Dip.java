...
public class Dip {
    ...
    private static int MAX_RANGE_NUMBERS = 49;
    private static int MAX_RANGE_STARS = 11;
    private static int HASH_CONST = 29;
    ...
    public int hashCode() {
        int hash = 3;
        hash = HASH_CONST * hash + Objects.hashCode(this.numbers);
        hash = HASH_CONST * hash + Objects.hashCode(this.starts);
        return hash;
    }
